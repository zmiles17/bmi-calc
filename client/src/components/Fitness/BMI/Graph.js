...
const BMIgraph = props => (
    ...
    <ScatterChart height={400} width={700} margin={{ top: 20, right: 30, bottom: 10, left: 10 }}>
        ...
        <Tooltip />
        <Legend align='right' />
        <Scatter name='Underweight' data={props.data.filter(e => e.category === 'underweight')} fill="blue" line lineType='fitting' />
        <Scatter name='Normal Weight' data={props.data.filter(e => e.category === 'normal weight')} fill="green" line lineType='fitting' />
        <Scatter name='Overweight' data={props.data.filter(e => e.category === 'overweight')} fill="yellow" line lineType='fitting' />
        <Scatter name='Obese' data={props.data.filter(e => e.category === 'obese')} fill="red" line lineType='fitting' />
    </ScatterChart>
    </ResponsiveContainer>
)
